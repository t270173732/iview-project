...
<script>
    ...
    export default {
        ...
        mounted() {
            if(this.$parent.patientsFormData.idCardBackUrl) {
                let bdOrgPicVO = {};
                bdOrgPicVO.url = this.$config.img_base_url + this.$parent.patientsFormData.idCardBackUrl;
        ...
        methods: {
            ...
            handleSuccess: function(res, file) {
                if(res.code == '200') {
                    ...
                    this.$parent.patientsFormData.idCardBackImg = this.imageFile;
                } else {
                    this.warn(res.msg);
                }
                this.limitImage = false;
