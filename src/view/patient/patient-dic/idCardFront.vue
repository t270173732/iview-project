...
<script>
    ...
    export default {
        ...
        mounted() {
            if(this.$parent.patientsFormData.idCardFrontUrl) {
                let bdOrgPicVO = {};
                bdOrgPicVO.url = this.$config.img_base_url + this.$parent.patientsFormData.idCardFrontUrl;
        ...
        methods: {
            ...
            handleSuccess: function(res, file) {
                if(res.code == '200') {
                    ...
                    this.$parent.patientsFormData.idCardFrontImg = this.imageFile;
                } else {
                    this.warn(res.msg);
                }
                this.limitImage = false;
