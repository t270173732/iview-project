...
<script>
    ...
    export default {
        ...
        mounted() {
            if(this.$parent.patientsFormData.miCardUrl) {
                let bdOrgPicVO = {};
                bdOrgPicVO.url = this.$config.img_base_url + this.$parent.patientsFormData.miCardUrl;
        ...
        methods: {
            ...
            handleSuccess: function(res, file) {
                if(res.code == '200') {
                    ...
                    this.$parent.patientsFormData.miCardImg = this.imageFile;
                } else {
                    this.warn(res.msg);
                }
                this.limitImage = false;
