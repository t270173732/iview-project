...
<script>
    ...
    import Image from '../../base-data/drug-store/drug-store-dictionary/image';
    import LicenseImage from '../../base-data/drug-store/drug-store-dictionary/licenseImage';
    import GspImage from '../../base-data/drug-store/drug-store-dictionary/gspImage';
    import LogoImage from '../../base-data/drug-store/drug-store-dictionary/logoImg';
