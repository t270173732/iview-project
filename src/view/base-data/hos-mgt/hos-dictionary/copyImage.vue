...
<script>
    ...
    export default {
        ...
        mounted() {
            if(this.$parent.hosInfoFormData.copyUrl) {
                let bdOrgPicVO = {};
                bdOrgPicVO.url = this.$config.img_base_url + this.$parent.hosInfoFormData.copyUrl;
        ...
        methods: {
            ...
            handleSuccess: function(res, file) {
                if(res.code == '200') {
                    ...
                    this.$parent.hosInfoFormData.copyImg = this.imageFile;
                } else {
                    this.warn(res.msg);
                }
                this.limitImage = false;
