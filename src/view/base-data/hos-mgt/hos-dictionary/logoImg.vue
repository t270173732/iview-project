...
<script>
    ...
    export default {
        ...
        mounted() {
            if(this.$parent.hosInfoFormData.logoUrl) {
                let bdOrgPicVO = {};
                bdOrgPicVO.url = this.$config.img_base_url + this.$parent.hosInfoFormData.logoUrl;
        ...
        methods: {
            ...
            handleSuccess: function(res, file) {
                if(res.code == '200') {
                    ...
                    this.$parent.hosInfoFormData.logoImg = this.imageFile;
                } else {
                    this.warn(res.msg);
                }
                this.limitImage = false;
