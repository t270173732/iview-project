...
<script>
    ...
    export default {
        ...
        mounted() {
            if(this.$parent.apoInfoFormData.idCardFrontUrl) {
                let bdOrgPicVO = {};
                bdOrgPicVO.url = this.$config.img_base_url + this.$parent.apoInfoFormData.idCardFrontUrl;
        ...
        methods: {
            ...
            handleSuccess: function(res, file) {
                if(res.code == '200') {
                    ...
                    this.$parent.apoInfoFormData.idCardFrontImg = this.imageFile;
                } else {
                    this.warn(res.msg);
                }
                this.limitImage = false;
