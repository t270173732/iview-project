...
<script>
    ...
    export default {
        ...
        mounted() {
            if(this.$parent.apoInfoFormData.idCardBackUrl) {
                let bdOrgPicVO = {};
                bdOrgPicVO.url = this.$config.img_base_url + this.$parent.apoInfoFormData.idCardBackUrl;
        ...
        methods: {
            ...
            handleSuccess: function(res, file) {
                if(res.code == '200') {
                    ...
                    this.$parent.apoInfoFormData.idCardBackImg = this.imageFile;
                } else {
                    this.warn(res.msg);
                }
                this.limitImage = false;
