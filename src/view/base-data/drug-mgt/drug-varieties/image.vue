...
<script>
    ...
    export default {
        ...
        mounted() {
            if(this.$parent.productFormData.picUrls) {
                for(let i=0;i<this.$parent.productFormData.picUrls.length;i++){
                    let bdOrgPicVO = {};
                    bdOrgPicVO.url = this.$config.img_base_url + this.$parent.productFormData.picUrls[i];
                    bdOrgPicVO.fileName = this.$parent.productFormData.picUrls[i];
        ...
        methods: {
            ...
            handleSuccess: function(res, file) {
                if(res.code == '200') {
                    ...
                    this.$parent.productFormData.picImgs = this.imageFile;
                } else {
                    this.warn(res.msg);
                }
            },
