...
<script>
    ...
    export default {
        ...
        mounted() {
            if (this.$parent.productFormData.thumbnailUrl) {
                let bdOrgPicVO = {};
                bdOrgPicVO.url = this.$config.img_base_url + this.$parent.productFormData.thumbnailUrl;
                bdOrgPicVO.fileName = this.$parent.productFormData.thumbnailUrl;
        ...
        methods: {
            ...
            handleSuccess: function (res, file) {
                if (res.code == '200') {
                    ...
                    this.$parent.productFormData.thumbnailImg = this.imageFile;
                } else {
                    this.warn(res.msg);
                }
                this.limitImage = false
