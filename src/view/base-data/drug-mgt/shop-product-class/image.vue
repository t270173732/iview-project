...
<script>
    ...
    export default {
        ...
        mounted() {
            if(this.$parent.classFormData.picUrl) {
                let bdOrgPicVO = {};
                bdOrgPicVO.url = this.$config.img_base_url + this.$parent.classFormData.picUrl;
        ...
        methods: {
            ...
            handleSuccess: function(res, file) {
                if(res.code == '200') {
                    ...
                    this.$parent.classFormData.picImg = this.imageFile;
                } else {
                    this.warn(res.msg);
                }
                this.limitImage = false;
