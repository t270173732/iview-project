...
<script>
    ...
    export default {
        ...
        mounted() {
            if(this.$parent.storeInfoFormData.logoUrl) {
                let bdOrgPicVO = {};
                bdOrgPicVO.url = this.$config.img_base_url + this.$parent.storeInfoFormData.logoUrl;
        ...
        methods: {
            ...
            handleSuccess: function(res, file) {
                if(res.code == '200') {
                    ...
                    this.$parent.storeInfoFormData.logoImg = this.imageFile;
                } else {
                    this.warn(res.msg);
                }
                this.limitImage = false;
