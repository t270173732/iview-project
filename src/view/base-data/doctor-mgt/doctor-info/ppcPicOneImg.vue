...
<script>
    ...
    export default {
        ...
        mounted() {
            if(this.$parent.docInfoFormData.ppcOneUrl) {
                let bdOrgPicVO = {};
                bdOrgPicVO.url = this.$config.img_base_url + this.$parent.docInfoFormData.ppcOneUrl;
        ...
        methods: {
            ...
            handleSuccess: function(res, file) {
                if(res.code == '200') {
                    ...
                    this.$parent.docInfoFormData.ppcOneImg = this.imageFile;
                } else {
                    this.warn(res.msg);
                }
                this.limitImage = false;
