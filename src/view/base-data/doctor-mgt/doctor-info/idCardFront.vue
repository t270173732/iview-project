...
<script>
    ...
    export default {
        ...
        mounted() {
            if(this.$parent.docInfoFormData.idCardFrontUrl) {
                let bdOrgPicVO = {};
                bdOrgPicVO.url = this.$config.img_base_url + this.$parent.docInfoFormData.idCardFrontUrl;
        ...
        methods: {
            ...
            handleSuccess: function(res, file) {
                if(res.code == '200') {
                    ...
                    this.$parent.docInfoFormData.idCardFrontImg = this.imageFile;
                } else {
                    this.warn(res.msg);
                }
                this.limitImage = false;
