...
<script>
    ...
    export default {
        ...
        mounted() {
            if(this.$parent.docInfoFormData.qcUrl) {
                let bdOrgPicVO = {};
                bdOrgPicVO.url = this.$config.img_base_url + this.$parent.docInfoFormData.qcUrl;
        ...
        methods: {
            ...
            handleSuccess: function(res, file) {
                if(res.code == '200') {
                    ...
                    this.$parent.docInfoFormData.qcImg = this.imageFile;
                } else {
                    this.warn(res.msg);
                }
                this.limitImage = false;
