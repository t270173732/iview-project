...
<script>
    import Vue from 'vue';
    let doc_grid_data_url = '/sys/sysDoctor/read/page';
    ...
    export default {
        data(){
            return{
                ...
                searchForm:{},
                searchFormData:{},
                docGridData: new this.customstore({
                    load: (loadOptions) => {
                        return this.CommDs.loadPage(loadOptions, doc_grid_data_url, this.isLoadData, {});
                    },
                }),
            }
        },
