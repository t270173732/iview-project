...
<script>
    ...
    export default {
        ...
        mounted() {
            if(this.$parent.docInfoFormData.tcUrl) {
                let bdOrgPicVO = {};
                bdOrgPicVO.url = this.$config.img_base_url + this.$parent.docInfoFormData.tcUrl;
        ...
        methods: {
            ...
            handleSuccess: function(res, file) {
                if(res.code == '200') {
                    ...
                    this.$parent.docInfoFormData.tcImg = this.imageFile;
                } else {
                    this.warn(res.msg);
                }
                this.limitImage = false;
