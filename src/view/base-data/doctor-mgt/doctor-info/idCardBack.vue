...
<script>
    ...
    export default {
        ...
        mounted() {
            if(this.$parent.docInfoFormData.idCardBackUrl) {
                let bdOrgPicVO = {};
                bdOrgPicVO.url = this.$config.img_base_url + this.$parent.docInfoFormData.idCardBackUrl;
        ...
        methods: {
            ...
            handleSuccess: function(res, file) {
                if(res.code == '200') {
                    ...
                    this.$parent.docInfoFormData.idCardBackImg = this.imageFile;
                } else {
                    this.warn(res.msg);
                }
                this.limitImage = false;
