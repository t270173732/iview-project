...
<script>
    ...
    export default {
        ...
        mounted() {
            if(this.$parent.supplierFormData.logoUrl) {
                let bdOrgPicVO = {};
                bdOrgPicVO.url = this.$config.img_base_url + this.$parent.supplierFormData.logoUrl;
        ...
        methods: {
            ...
            handleSuccess: function(res, file) {
                if(res.code == '200') {
                    ...
                    this.$parent.supplierFormData.logoImg = this.imageFile;
                } else {
                    this.warn(res.msg);
                }
                this.limitImage = false;
