...
<script>
    ...
    export default {
        ...
        mounted() {
            if(this.$parent.articleFormData.photoUrl) {
                let bdOrgPicVO = {};
                bdOrgPicVO.url = this.$config.img_base_url + this.$parent.articleFormData.photoUrl;
        ...
        methods: {
            ...
            handleSuccess: function(res, file) {
                if(res.code == '200') {
                    ...
                    this.$parent.articleFormData.photoImg = this.imageFile;
                } else {
                    this.warn(res.msg);
                }
                this.limitImage = false;
