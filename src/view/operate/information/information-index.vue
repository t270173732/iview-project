...
<script>
    ...
    let article_del_url = '/biz/bizArticle/deleteArticle';
    ...
    export default {
        data(){
            return{
                ...
                infomationGridData: new this.customstore({
                    load: (loadOptions) => {
                        return this.CommDs.loadPage(loadOptions, infomation_grid_data_url, this.isLoadData, {});
                    },
                }),
        ...
        methods:{
            ...
            del(data){
                let params = {};
                params.id = data.id;
                this.$post(article_del_url,params).then(res => {
                    if(res.code=='200') {
                        this.success('删除成功!',()=>{
                            this.infomationGrid.refresh();
                        });
