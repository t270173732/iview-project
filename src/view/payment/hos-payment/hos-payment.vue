<style lang="less">
    ...
    @import "../platform-payment/record.css";
</style>
<template>
    <div>
        <Card dis-hover>
        ...
        <Drawer :closable="false" width="500" v-model="visible">
            <table class="table_record">
                ...
                <tr>
                    ...
                    <td class="table_record_td text_center">{{recordInfo.orderType}}</td>
                </tr>
                <tr>
    ...
    export default {
        ...
        methods:{
            ...
            exportRecord(){
                ...
                // form.attr("action","http://192.168.0.110:8090/bizOrder/exportDrugStoreOrderSummary");
                $("body").append(form);
