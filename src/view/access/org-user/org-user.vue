    ...
    export default {
        data(){
            return {
                ...
                companyTreeListData: new this.customstore({
                    key:'id',
                    load: (loadOptions)=> {
                        return this.CommDs.loadList(company_list_url);
                    },
                }),
        ...
        methods:{
            ...
            addUser(){
                ...
                this.userEditForm.itemOption('status','editorOptions',{
                    dataSource: this.enum.status,
                    displayExpr: "text",
                    valueExpr: "id",
                    readOnly:false
            ...
            resetPwSubmit(){
                ...
                this.resetPwFormData.password = this.resetPwFormData.newPass;
                params = this.resetPwFormData;
